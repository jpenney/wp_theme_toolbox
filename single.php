...
<?php the_post(); ?>
				...
				<div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
					...
					<div class="entry-meta">
						<span class="meta-prep meta-prep-author"><?php _e( 'Posted by ', 'theme' ); ?></span>
						...
						<span class="meta-sep"><?php _e( ' on ', 'theme' ); ?> </span>
...
<?php if ( get_the_author_meta('description') ) : // If a user has filled out their decscription show a bio on their entries  ?>
					<div id="entry-author-info">
						...
						<div id="author-description">
							<h2><?php _e( 'About ', 'theme' ); ?><?php the_author(); ?></h2>
							<?php the_author_meta('description'); ?>
							<div id="author-link">
								<a href="<?php echo get_author_posts_url( get_the_author_meta('ID') ); ?>" title="<?php printf( esc_attr__( 'View all posts by %s', 'theme' ), get_the_author() ); ?>"><?php _e( 'View all posts by ', 'theme' ); ?><?php the_author(); ?> &rarr;</a>
							</div><!-- #author-link	-->
